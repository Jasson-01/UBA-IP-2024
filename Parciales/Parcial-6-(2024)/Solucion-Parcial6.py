...
# Ejemplos de prueba
print(cuantos_sufijos_son_palindromos("Diego"))  # Debería imprimir 1 ("o" es el único sufijo palíndromo)
print(cuantos_sufijos_son_palindromos("aabaa"))  # Debería imprimir 3 ("aabaa", "aa", "a" son palíndromos)
print(cuantos_sufijos_son_palindromos("racecar"))  # Debería imprimir 1 ("racecar" es el único sufijo palíndromo)
print(cuantos_sufijos_son_palindromos("abc"))  # Debería imprimir 0 (no hay sufijos palíndromos)
print(cuantos_sufijos_son_palindromos("ababa"))  # Debería imprimir 2 ("ababa", "a" son palíndromos)
